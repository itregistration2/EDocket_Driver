...
import { onGetThisDockets } from '../../redux/actions/AppAction';
...
export default DetailContainer = (props) => {
    ...
    useEffect(() => {
        dispatch(onGetThisDockets(props.item.DOCKETID, (data) => {
    ...
    }, [props.item && props.item.DOCKETID])
                    ...
                    {section.id == 1 ?
                                    ...
                                    <>
                                        ...
                                        <View style={{ flexDirection: "row", justifyContent: "space-evenly" }}>
                                            ...
                                            <GradientButton
                                                ...
                                                buttonPress={() => { Linking.openURL(`tel:${currentDelivery?.PLANTPHONE}`) }}
                                            />
                                        </View>
                                    </>
                                }
                        ...
                        : section.id == 2 ?
                            <View style={styles.seperate_row_st}>
                                ...
                                <>
                                    ...
                                    <View style={styles.itemRow}>
                                        ...
                                        {
                                            currentDelivery?.SITECONTACT.split(" ")[0].split("/").length > 1 ?
                                                <Text style={{ ...styles.item_txt, width: wp(48), fontSize: wp(global.FontSizeSelect == 'M' ? 3.6 : global.FontSizeSelect == 'L' ? 4.6 : 2.6) }}>
                                                    {currentDelivery?.SITECONTACT.split(" ")[0].split("/").map((r, index) => {
                                                        return <View style={{ flexDirection: "row", flexWrap: 'wrap' }}><Text style={{ color: colors.DODGER_BLUE }} onPress={() => Linking.openURL(`tel:${r}`)}>{((index + 1) == currentDelivery?.SITECONTACT.split(" ")[0].split("/").length) ? <Text style={{ fontFamily: fonts.BOLD }}>{r + " "}</Text> : <><Text style={{ fontFamily: fonts.BOLD }}>{r}</Text><Text style={{ color: colors.GRAY_TXT }}>{" / "}</Text></>}</Text></View>
                                                    })}
                                                    <Text>{currentDelivery?.SITECONTACT.split(" ")[1]}</Text>
                                                </Text>
                                                :
                                                <Text onPress={() => { Linking.openURL(`tel:${currentDelivery?.SITECONTACT.split(" ")[0]}`) }} style={{ ...styles.item_txt, width: wp(48), fontSize: wp(global.FontSizeSelect == 'M' ? 3.6 : global.FontSizeSelect == 'L' ? 4.6 : 2.6) }}><Text style={{ color: colors.DODGER_BLUE, fontFamily: fonts.BOLD }}>{currentDelivery?.SITECONTACT.split(" ")[0]}</Text><Text>{" " + currentDelivery?.SITECONTACT.split(" ")[1]}</Text></Text>
                                        }
                                    </View>
                                    <View style={styles.itemRow}>
                            ...
                            <>
                                ...
                                {currentDelivery?.THK_JOBISHOUSINGJOB == 1 &&
