...
const AnimatedScreenElement = ({ animatedStyle, children, unboxed, interpolate, style, }) => {
    ...
    return (React.createElement(React.Fragment, null, React.Children.map(children, (child) => (React.createElement(Animated.View, { style: [
